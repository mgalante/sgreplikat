define(['plugins/http','helpers/serializer','jquery','knockout', 'helpers/appSettings'],function(http,serializer,$,ko,appSettings){
    ...
    var ordendecompras = {
        getAll: function()
        {
            ...
            http.get(appSettings.root + "ordendecompras/list").then(function(data){
        ...
        {
            var dfd = new $.Deferred();
            http.get(appSettings.root + "ordendecompras/get/" + id).then(function(data){
                dfd.resolve(serializer.deserialize(JSON.stringify(data)));
            }).fail(function(){
                dfd.reject();
            });
        ...
        save: function(item)
        {
            return $.ajax({
                dataType: 'json',
                type: 'post',
                url: appSettings.root + "ordendecompras/save",
        ...
        delete: function(id)
        {
            return $.ajax({
                dataType: 'json',
                type: 'post',
                url: appSettings.root + "ordendecompras/delete/" + id
            });
        }
    };
